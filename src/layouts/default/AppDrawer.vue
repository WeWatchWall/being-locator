<template>
  ...
  >
    ...
    <v-select
      clearable
      :label="appStore.translations[appStore.translations.lang].interest.name"
      :items="appStore.translations[appStore.translations.lang].interest.options"
      multiple
    ...
    <v-select
      ...
      multiple
      v-model="appStore.drawer.value[5]"
      class="my-2 mx-2"
    ></v-select>
